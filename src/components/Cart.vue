<template>
  <b-container fluid class="mt-4">
          ...
          <template v-slot:cell(image)="data">
            <b-col class="text-center">
              <b-img
                ...
                :src="require(`../assets/products/${data.item.image1}`)"
                fluid
    ...
    <b-row class="text-center" v-if="cart.length > 0">
      ...
      <b-col>
        <h3>{{ total }} FCFA</h3></b-col
      >
    </b-row>
    <b-row class="m4-4 text-center" v-if="cart.length > 0">
      <b-col>
      ...
      <b-col> </b-col>
      <b-col cols="4"> Azamarket official e-commerce website </b-col>
      <b-col></b-col>
      <b-col>
...
export default {
  ...
  methods: {
    ...
    buy() {
      ...
      //Save ticket in database (commandes ou factures)
